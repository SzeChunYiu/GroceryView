...
describe('daily ingestion workflow', () => {
  it('runs on a daily schedule and fails closed on missing deployed ingestion evidence', () => {
    ...
    assert.match(workflow, /postgres_readiness_skipped_after_db_connectivity_not_ready/);
    assert.match(workflow, /postgres_readiness_skip_status/);
    ...
    assert.match(workflow, /source_run_readiness_skipped_after_db_connectivity_not_ready/);
    assert.match(workflow, /source_run_readiness_skip_status/);
    ...
    assert.match(workflow, /catalog_coverage_readiness_skipped_after_db_connectivity_not_ready/);
    assert.match(workflow, /catalog_coverage_readiness_skip_status/);
    ...
    assert.match(workflow, /connectivityStatus/);
    assert.match(workflow, /connectivityBlockers/);
