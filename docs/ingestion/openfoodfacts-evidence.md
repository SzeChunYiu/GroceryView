...
- Retrieved: 2026-05-22T14:38:01.825Z
- Candidate barcode count checked from current City Gross/Willys/Hemkop/Coop/ICA ingested rows: 3690
- Candidate source surfaces: citygross/products 24 unique barcodes from 960/960 rows; willys/products 150 unique barcodes from 150/150 rows; willys/weeklyDiscounts 201 unique barcodes from 11943/12124 rows; hemkop/products 2099 unique barcodes from 2099/2100 rows; hemkop/weeklyDiscounts 247 unique barcodes from 14912/14912 rows; coop/products 290 unique barcodes from 290/290 rows; coop/weeklyDiscounts 32 unique barcodes from 1626/1626 rows; ica/reklambladOffers 1153 unique barcodes from 638/638 rows; ica/storePromotions 5 unique barcodes from 1245/74700 rows
- Export rows scanned: 4528597
- Candidate barcodes present in export: 2147
- Candidate barcodes not present in export and skipped: 1543
- Matched rows without usable nutrition/name skipped: 355
- Real rows fetched: 1792 barcode+nutrition rows matched to existing ingested retailer products
- Retailer rows linked by those real barcodes: 18206
...
- Verified: 2026-05-22T14:38:01.825Z
...
- Artifact audit: `rowCount` 1792 equals 1792 emitted barcode rows; `retailerMatchCount` 18206 equals emitted retailer match links; all emitted barcodes are unique; `candidateBarcodeCount` 3690 equals the unique usable current candidate barcodes; every emitted barcode appears in those current candidates; zero emitted rows have empty nutrition; zero emitted rows use a source outside `https://world.openfoodfacts.org/data/en.openfoodfacts.org.products.csv.gz#code=...`.
