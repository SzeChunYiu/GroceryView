...
- the latest `daily-ingestion.yml` run passes and includes the `groceryview-production-ingestion-config`, `groceryview-db-site-snapshot`, and `groceryview-deployed-readiness` artifacts.
