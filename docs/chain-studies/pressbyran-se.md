...
| Loyalty program | Pressbyrån's customer club is `Pressbyrån Kompis`. Membership is created by downloading the Pressbyrån app and creating an account; the FAQ says users must be at least 16. The app FAQ says purchases of at least 15 kr earn stamps, limited to 4 stamps per day and 1 per 30 minutes, and every 5 stamps gives a reward redeemable as a discount or free coupon. `Bästis` gives more reward choices after 15 stamps in 3 months. | The reviewed Pressbyrån pages name the program `Pressbyrån Kompis`; they do not state that it is the same loyalty program as 7-Eleven. The connector has a source-backed `Pressbyrån Kompis` member/coupon promotion row for Kompisfika and keeps generic magazine rows non-member. |
...
- Privacy information: states Reitan Convenience Sweden AB operates service-store retail through Pressbyrån, PBX, and 7-Eleven, and references bonus-qualifying purchases registered in the Pressbyrån or 7-Eleven apps; it does not rename Pressbyrån Kompis as a shared 7-Eleven program. Source: https://www.pressbyran.se/kontakt/behandling-av-personuppgifter/
