...
- AdMob/AdSense and subscription billing integration. Provider-neutral monetization contracts, provider-readiness gates, and subscription entitlement persistence exist; real provider credentials, webhook endpoints, provider-specific adapters, live checkout/ad-serving proof, and account UI enforcement still missing.
