...
- AdMob/AdSense and subscription billing integration. Provider-neutral monetization contracts, provider-readiness gates, subscription entitlement persistence, and entitlement access policy exist; real provider credentials, webhook endpoints, provider-specific adapters, live checkout/ad-serving proof, and account UI/API wiring still missing.
