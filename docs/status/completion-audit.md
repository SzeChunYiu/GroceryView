...
| --- | --- | --- |
| Iterative PR + merge workflow | PR #1 through PR #36 and PR #88 through PR #102 merged to `main` after this iteration | Done for shipped iterations |
...
- Push/email provider adapters and production notification workers. Provider-neutral delivery, worker tick orchestration, persisted task schedules, suppression filtering, and persisted suppression records exist; real provider credentials, deployed workers, unsubscribe/bounce webhook processing, and observability still missing.
