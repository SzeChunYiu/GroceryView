...
- Real retailer/API/crawler connectors and legal/robots review. Retailer source access gates and an approved-connector runner exist; provider-specific parsers, live credentials/endpoints, durable snapshot storage, completed legal reviews, and hosted worker proof are still missing.
