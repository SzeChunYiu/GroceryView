-- Subscription entitlement state for account enforcement.
-- Stores provider identifiers only; card data, client secrets, and payment methods stay with the billing provider.
