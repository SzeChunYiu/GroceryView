...
function FriendPriceSightingsPanel({ card }: Readonly<{ card: AdaptiveProductCard }>) {
  ...
  return (
    <div className="mt-3 rounded-2xl border border-emerald-200 bg-emerald-50 p-3">
      <p className="text-[0.65rem] font-black uppercase tracking-[0.18em] text-emerald-900">Friend & household price sightings</p>
        ...
        {sightings.map((sighting) => (
          <li className="rounded-xl bg-white p-2 text-xs text-slate-700" key={sighting.id}>
            ...
            <p className="mt-1 font-semibold">
              {friendPriceSightingSummary(sighting)} · {sighting.observedAt.slice(0, 10)} · {sighting.confidence} confidence
            </p>
