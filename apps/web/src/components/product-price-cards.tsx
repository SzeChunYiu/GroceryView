        ...
        {sortedCards.map((card, index) => (
          <div className="relative" key={card.slug}>
            ...
            {card.cheapestUnitBadge ? (
              <p className="mt-2 inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-950" data-badge-type="cheapest-per-unit">{card.cheapestUnitBadge}</p>
            ) : null}
