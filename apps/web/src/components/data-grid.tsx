...
export function DataGrid({ className = '', striped = true, ...props }: Readonly<DataGridProps>) {
  ...
  return (
    <div
      ...
      className={[
        ...
        '[&_table]:w-full [&_td]:border-t [&_td]:border-slate-100 [&_td]:px-4 [&_td]:py-3 [&_th]:px-4 [&_th]:py-3 [&_th]:text-left',
        striping,
        className
      ].filter(Boolean).join(' ')}
    />
