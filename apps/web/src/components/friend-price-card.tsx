  ...
  return (
    <div className="rounded-2xl border border-fuchsia-100 bg-white/90 p-4 shadow-sm">
      ...
      <p className="mt-2 text-sm font-semibold text-slate-600">
        {sighting.action} by {relationship} · observed {sighting.observedAt.slice(0, 10)} · {sighting.confidence} confidence
      </p>
      {sighting.note ? <p className="mt-2 text-xs font-bold text-fuchsia-900">{sighting.note}</p> : null}
