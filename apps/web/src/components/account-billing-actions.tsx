        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm font-semibold leading-6 text-violet-950">
              Forecasted monthly savings stay premium-only and combine observed alerts, saved swaps, and basket-planning source rows after subscription access is loaded.
            </p>
          </div>
