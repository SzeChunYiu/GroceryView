        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm font-semibold leading-6 text-violet-950">
              Forecasted monthly savings stay premium-only and are derived from observed source rows for alerts, swaps, and basket-planning signals after subscription access is loaded.
            </p>
          </div>
