        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, paddingRight: 44 }}>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 40 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ fontSize: 32, fontWeight: 900 }}>GroceryView</div>
              <div style={{ fontSize: 19, color: '#047857', fontWeight: 800 }}>Verified item price card</div>
            </div>
          </div>
          ...
          <div style={{ fontSize: 28, color: '#334155', fontWeight: 800, marginTop: 16 }}>
            {model.brand}
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', marginTop: 'auto' }}>
            <div style={{ fontSize: 24, color: '#334155', fontWeight: 900 }}>{model.priceContext}</div>
            <div style={{ display: 'flex', alignItems: 'flex-end', marginTop: 8 }}>
              <div style={{ fontSize: 92, lineHeight: 1, color: '#047857', fontWeight: 900 }}>{model.priceLabel}</div>
            </div>
            <div style={{ fontSize: 22, color: '#475569', fontWeight: 800, marginTop: 14 }}>
        ...
        >
          {model.image ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#047857', fontWeight: 900 }}>
              <div style={{ fontSize: 92 }}>GV</div>
              <div style={{ fontSize: 24, marginTop: 16 }}>No item photo</div>
            </div>
          )}
        </div>
      </div>
