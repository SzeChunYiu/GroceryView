    ...
    <PageShell>
      ...
      <Card className="mt-6 border-emerald-200 bg-emerald-50">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.2em] text-emerald-800">Verified deal screener</p>
            <h2 className="mt-2 text-2xl font-black tracking-tight text-slate-950">Ranked deal board moved to /screener</h2>
            <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-slate-700">
              This section now points to the dedicated ranked screener surface for biggest-drop, cheapest-per-kg, and cross-chain spread ranking of verified rows.
            </p>
          </div>
          <div className="rounded-2xl bg-white p-4 shadow-sm">
            <Link
              href="/screener"
              className="inline-flex rounded-lg bg-emerald-800 px-4 py-2 text-sm font-black text-white transition hover:bg-emerald-950"
            >
              Open ranked screener
            </Link>
            <p className="mt-3 text-sm font-semibold text-slate-700">
              Move from this legacy card to the dedicated route for advanced sorting and confidence filtering.
            </p>
          </div>
        </div>
      </Card>
