...
export default async function ProductsPage({ searchParams }: { searchParams?: Promise<SearchParams> }) {
  ...
  const virtualizedResultCards = resultCards.map((product) => ({
    ...product,
      ...
      <Card className="mt-8 border-violet-200 bg-violet-50/70">
        ...
        <div className="mt-5 grid gap-3 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-violet-100 bg-white p-4 shadow-sm">
            ...
            <p className="mt-3 text-2xl font-black text-slate-950">{formatSek(normalizedPriceRange.min)} – {formatSek(normalizedPriceRange.max)}</p>
