  ...
  return (
    <PageShell>
      ...
      <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-700">
        The fuel/pharmacy domain model is wired at catalog and schema level, but GroceryView does not render pharmacy prices until an OTC connector writes domain=pharmacy observations. Prescription medicine stays excluded.
      </p>

      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <Card>
          <p className="text-sm font-black uppercase tracking-[0.2em] text-slate-500">Status</p>
          <p className="mt-2 text-4xl font-black text-slate-950">No pharmacy price observations yet</p>
