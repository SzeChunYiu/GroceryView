        ...
        <div className="grid gap-4 p-6 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-slate-200">
              The map ↔ list sync uses verified OSM coordinates and chain-index proxy colors. Dense areas cluster stores, and marker popovers show distance and open-hours metadata without inventing branch-level basket prices.
            </p>
          </div>
