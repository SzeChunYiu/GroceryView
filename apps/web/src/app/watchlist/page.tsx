    ...
    <PageShell>
      ...
      <Card className="mt-6 border-cyan-200 bg-cyan-50">
        ...
        <p className="mt-3 max-w-3xl text-sm font-semibold leading-6 text-slate-700">
          Forecasted drops are generated from observed price history before current threshold alerts fire, so shoppers can wait for near-term savings windows instead of buying right before a likely discount.
        </p>
