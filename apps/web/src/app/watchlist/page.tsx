  ...
  return (
    <PageShell>
      ...
      <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-700">
        This page calls buildWatchlistAlerts with verified chain price rows, then runs planNotifications so set-target push and email rows respect user preferences and quiet-hour rules. Predictive drop alerts also surface historical price observations before a current threshold is crossed.
      </p>
