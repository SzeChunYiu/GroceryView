const unknownUnitPriceLabel = 'Jämförpris saknas';
const unitPriceDisplayUnits = ['kg', 'l', 'st', '100 g'];
...
function normalizeUnitPriceDisplayUnit(value) {
  if (typeof value !== 'string') return null;
...
function formatUnitPriceLabel(value, unit, options = {}) {
...
function formatPer100gUnitPriceLabel(valuePerKg, options = {}) {
...
function formatSourceUnitPriceText(text, unit, options = {}) {
