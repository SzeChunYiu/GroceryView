...
export const icaStorePromotionSourceSummary: IcaStorePromotionSourceSummary = {
  ...
  latestStores: [
    {
      retrievedAt: '2026-05-23T15:31:20.601Z',
      rowCount: 1,
      storeAccountId: '1003822',
      storeName: 'ICA Supermarket Toria',
      regionId: '6ae1c52a-99a8-4b19-9464-dd01274df39d',
      sourceUrl: 'https://handlaprivatkund.ica.se/stores/1003822/api/product-listing-pages/v1/pages/promotions?regionId=6ae1c52a-99a8-4b19-9464-dd01274df39d&includeAdditionalPageInfo=true&maxProductsToDecorate=1&maxPageSize=1'
    },
    {
