...
test.describe('weekly basket page smoke', () => {
  ...
  test('renders, has reachable controls, clean console/images, and passes Lighthouse a11y smoke', async ({ page }) => {
    ...
    await page.goto('/weekly-basket');
    await page.waitForLoadState('networkidle');
    await expect(page.getByRole('heading', { name: /weekly basket|cheapest route/i })).toBeVisible();
    await expect(page.getByText(/basket optimizer|split-shop|coverage confidence/i).first()).toBeVisible();
