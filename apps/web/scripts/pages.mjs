...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Store</div><h1>Willys Odenplan</h1><p class="lede">Favorite-store profile for Odenplan grocery deals.</p><div class="grid"><div class="metric"><strong>82</strong><span>Deal Score Today</span></div><div class="metric"><strong>-5.3%</strong><span>overall price level vs Stockholm</span></div><div class="metric"><strong>67th</strong><span>Within Willys stores percentile</span></div></div></section><section class="card" style="margin-top:16px"><h2>Store price-level profile</h2><table class="table"><thead><tr><th>Metric</th><th>Signal</th></tr></thead><tbody><tr><td>Best categories</td><td>Coffee, Frozen, Cleaning</td></tr><tr><td>Worst categories</td><td>Fresh vegetables</td></tr><tr><td>Deal density this week</td><td>High</td></tr><tr><td>Watchlist match count</td><td>2 tracked products</td></tr><tr><td>Favorite-store percentile</td><td>67th among my stores</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Store highlights</h2><table class="table"><thead><tr><th>Category</th><th>Signal</th><th>Confidence</th></tr></thead><tbody><tr><td>Coffee</td><td>-12% vs Stockholm average</td><td>Verified shelf</td></tr><tr><td>Milk</td><td>Competitive family basket line</td><td>Retailer page</td></tr><tr><td>Butter</td><td>Watchlist only, above usual price</td><td>Estimated</td></tr></tbody></table></section>`
  },
  {
