...
const pages = [
  ...
  {
    path: 'price-confidence/index.html',
    title: 'Price confidence — GroceryView',
    description: 'GroceryView price confidence page for source age, verification status, and shopper-safe claim rules.',
    body: `<section class="card"><div class="eyebrow">Price trust</div><h1>Price confidence</h1><p class="lede">Every displayed price can show where it came from, how fresh it is, and whether GroceryView can make a savings claim.</p><div class="grid"><div class="metric"><strong>Verified</strong><span>receipt or retailer source</span></div><div class="metric"><strong>24h</strong><span>freshness target for top deals</span></div><div class="metric"><strong>Claim gated</strong><span>low confidence avoids savings copy</span></div></div></section><section class="card" style="margin-top:16px"><h2>Source rules</h2><table class="table"><thead><tr><th>Signal</th><th>Display state</th><th>Shopper promise</th></tr></thead><tbody><tr><td>Retailer feed under 24h</td><td>High confidence</td><td>Eligible for best-price and savings claims</td></tr><tr><td>Receipt confirmed by reviewer</td><td>Verified shelf price</td><td>Shown with receipt-backed provenance</td></tr><tr><td>Community report pending review</td><td>Needs confirmation</td><td>Displayed as a hint, never as a guaranteed saving</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Claim guardrails</h2><table class="table"><thead><tr><th>Claim</th><th>Required evidence</th><th>Fallback copy</th></tr></thead><tbody><tr><td>Best price nearby</td><td>Two or more selected stores checked</td><td>Current observed price</td></tr><tr><td>Save this week</td><td>Fresh comparison and matching unit size</td><td>Compare before buying</td></tr><tr><td>Historic low</td><td>Enough price history for the product</td><td>Below recent average</td></tr></tbody></table></section>`
  },
  {
