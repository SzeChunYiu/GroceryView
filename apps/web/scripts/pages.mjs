...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Category</div><h1>Stockholm Coffee Deals</h1><p class="lede">Coffee Index is at 91.6 with strong current promotions.</p><div class="grid"><div class="metric"><strong>-8.4%</strong><span>1M move</span></div><div class="metric"><strong>12th</strong><span>Historical percentile</span></div><div class="metric"><strong>Zoégas</strong><span>Top deal</span></div></div></section><section class="card" style="margin-top:16px"><h2>Category deal feed</h2><table class="table"><thead><tr><th>Product</th><th>Unit price</th><th>Deal Score</th><th>Context</th></tr></thead><tbody><tr><td>ZOEGAS-COFFEE-450G<br><span class="footer-note">national brand · shelf · high confidence</span></td><td>110.89 SEK/kg</td><td>82</td><td>12th historical percentile; observed 2026-05-19</td></tr><tr><td>Garant Bryggkaffe 450g<br><span class="footer-note">standard private label · shelf · medium confidence</span></td><td>88.67 SEK/kg</td><td>79</td><td>Private-label option is 20% cheaper by unit price</td></tr><tr><td>Coop Mellanrost 500g<br><span class="footer-note">promo estimate · low confidence</span></td><td>95.80 SEK/kg</td><td>66</td><td>Unverified promo-only record; compare before switching</td></tr></tbody></table><p class="lede">Private-label savings are shown as category context, not automatic substitutions.</p></section>`
  }
];
