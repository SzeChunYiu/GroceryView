...
const pages = [
  ...
  {
    path: 'screener/index.html',
    title: 'Grocery screener — GroceryView',
    description: 'TradingView-style grocery screener for filtering Stockholm products by category, chain, favorite stores, area, Deal Score, and confidence.',
    body: `<section class="card"><div class="eyebrow">Screener</div><h1>Grocery screener</h1><p class="lede">Filter grocery instruments by category, supermarket chain, favorite stores, district, Deal Score, and price confidence.</p><div class="toolbar"><span class="pill">Category: Coffee</span><span class="pill">Chain: Willys + ICA</span><span class="pill">Favorite stores only</span><span class="pill">Area: Stockholm inner city</span><span class="pill">Deal Score ≥ 80</span><span class="pill">Confidence ≥ 75%</span></div></section><section class="card" style="margin-top:16px"><h2>Screened opportunities</h2><table class="table"><thead><tr><th>Product</th><th>Category</th><th>Best chain</th><th>Area</th><th>Best price</th><th>7D</th><th>Deal Score</th><th>Confidence</th><th>Alert</th></tr></thead><tbody><tr><td>ZOEGAS-COFFEE-450G</td><td>Coffee</td><td>Willys</td><td>Odenplan</td><td>49.90 SEK</td><td class="negative">-12.4%</td><td>94</td><td>91%</td><td>Below target</td></tr><tr><td>ARLA-MILK-1L</td><td>Dairy</td><td>Lidl</td><td>Sveavägen</td><td>13.90 SEK</td><td class="negative">-4.2%</td><td>82</td><td>86%</td><td>Watch</td></tr><tr><td>BUTTER-600G</td><td>Dairy</td><td>Coop</td><td>Södermalm</td><td>54.90 SEK</td><td class="positive">+2.1%</td><td>42</td><td>72%</td><td>Wait</td></tr></tbody></table></section>`
  },
  {
