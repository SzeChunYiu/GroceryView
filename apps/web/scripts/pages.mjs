...
const pages = [
  ...
  },
  {
    ...
    title: 'Receipt history — GroceryView',
    description: 'GroceryView receipt history for budget reconciliation, review status, redaction, and price contribution confidence.',
    body: `<section class="card"><div class="eyebrow">Receipts</div><h1>Receipt history</h1><p class="lede">Review captured receipts before they reconcile the weekly budget or contribute observed prices to the catalog.</p><div class="grid"><div class="metric"><strong>501 SEK</strong><span>reviewed spend this week</span></div><div class="metric"><strong>2 pending</strong><span>receipts need confirmation</span></div><div class="metric"><strong>7 days</strong><span>image retention window</span></div></div></section><section class="card" style="margin-top:16px"><h2>Budget reconciliation</h2><table class="table"><thead><tr><th>Receipt</th><th>Status</th><th>Budget impact</th><th>Catalog action</th></tr></thead><tbody><tr><td>Coop Farsta</td><td>Needs human review</td><td>Hold 321 SEK until milk line confirmed</td><td>No price contribution yet</td></tr><tr><td>Willys Odenplan</td><td>Reviewed</td><td>Apply 180 SEK to weekly spend</td><td>Contribute verified shelf observations</td></tr><tr><td>Lidl Sveavägen</td><td>Redacted</td><td>Apply total only</td><td>Receipt image deleted after review</td></tr></tbody></table></section>`
  },
  {
