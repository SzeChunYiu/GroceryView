...
const pages = [
  ...
  {
    path: 'budget/index.html',
    title: 'Budget tracker — GroceryView',
    description: 'GroceryView budget tracker for weekly and monthly budget guardrails, basket forecast, category budgets, and receipt review.',
    body: `<section class="card"><div class="eyebrow">Budget</div><h1>Budget tracker</h1><p class="lede">Track weekly and monthly grocery guardrails before the basket plan becomes receipt spend.</p><div class="grid"><div class="metric"><strong>800 SEK</strong><span>weekly budget</span></div><div class="metric"><strong>3 200 SEK</strong><span>monthly budget</span></div><div class="metric"><strong>742 SEK</strong><span>basket forecast</span></div></div></section><section class="market" style="margin-top:16px"><div class="card"><h2>Category budgets</h2><table class="table"><thead><tr><th>Category</th><th>Planned</th><th>Spent</th><th>Status</th></tr></thead><tbody><tr><td>Coffee</td><td>120 SEK</td><td>49.90 SEK</td><td><span class="status">under</span></td></tr><tr><td>Dairy</td><td>180 SEK</td><td>122.60 SEK</td><td><span class="status">watch</span></td></tr><tr><td>Protein</td><td>260 SEK</td><td>190.00 SEK</td><td><span class="status">under</span></td></tr></tbody></table></div><div class="card"><h2>In-store running total</h2><p class="lede">Placeholder mode keeps live aisle totals separate from verified receipts until checkout evidence is reviewed.</p><div class="grid"><div class="metric"><strong>312 SEK</strong><span>running total</span></div><div class="metric"><strong>488 SEK</strong><span>weekly room left</span></div><div class="metric"><strong>2</strong><span>receipt reviews pending</span></div></div></div></section>`
  },
  {
