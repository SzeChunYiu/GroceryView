...
const pages = [
  ...
  {
    path: 'watchlist/index.html',
    title: 'Grocery watchlist — GroceryView',
    description: 'TradingView-style grocery watchlist with best price, favorite-store price, movement, percentiles, Deal Score, and alert status.',
    body: `<section class="card"><div class="eyebrow">Watchlist</div><h1>Grocery watchlist</h1><p class="lede">Track grocery tickers like a portfolio and see which watched products are below target, at 52-week lows, or worth waiting on.</p><div class="grid"><div class="metric"><strong>4</strong><span>watched products</span></div><div class="metric"><strong>2</strong><span>alerts active</span></div><div class="metric"><strong>94</strong><span>top Deal Score</span></div></div></section><section class="card" style="margin-top:16px"><h2>Watchlist panel</h2><table class="table"><thead><tr><th>Product</th><th>Best price</th><th>Favorite-store price</th><th>7D</th><th>30D</th><th>Stockholm percentile</th><th>Historical percentile</th><th>Deal Score</th><th>Alert status</th></tr></thead><tbody><tr><td>ZOEGAS-COFFEE-450G</td><td>49.90 SEK</td><td>49.90 SEK at Willys Odenplan</td><td class="negative">-12.4%</td><td class="negative">-8.1%</td><td>11th</td><td>6th</td><td>94</td><td>Below target</td></tr><tr><td>BUTTER-600G</td><td>54.90 SEK</td><td>58.90 SEK at Coop Medborgarplatsen</td><td class="positive">+2.1%</td><td class="positive">+3.4%</td><td>58th</td><td>61st</td><td>42</td><td>Wait</td></tr><tr><td>EGGS-12P</td><td>34.90 SEK</td><td>36.90 SEK at Willys Odenplan</td><td class="negative">-4.2%</td><td class="negative">-2.0%</td><td>22nd</td><td>28th</td><td>71</td><td>Fair</td></tr><tr><td>TOILET-PAPER-8P</td><td>69.90 SEK</td><td>72.90 SEK at ICA Liljeholmen</td><td class="negative">-18.0%</td><td class="negative">-14.5%</td><td>8th</td><td>4th</td><td>88</td><td>Stock up</td></tr></tbody></table></section>`
  },
  {
