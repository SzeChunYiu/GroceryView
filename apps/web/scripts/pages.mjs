...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Watchlist</div><h1>Price watchlist workbench</h1><p class="lede">Review target prices, Deal Score triggers, source confidence, and notification readiness before alerts reach a household.</p><div class="grid"><div class="metric"><strong>4</strong><span>tracked staples</span></div><div class="metric"><strong>2</strong><span>alerts ready</span></div><div class="metric"><strong>1</strong><span>held for review</span></div></div></section><section class="card" style="margin-top:16px"><h2>Tracked items</h2><table class="table"><thead><tr><th>Product</th><th>Target</th><th>Current</th><th>Trigger</th><th>Allowed price types</th><th>Status</th></tr></thead><tbody><tr><td>Zoégas Coffee 450g</td><td>50 SEK</td><td>49.90 SEK</td><td>Deal Score ≥ 80</td><td>Shelf, promotion</td><td>Ready for push</td></tr><tr><td>Butter 600g</td><td>45 SEK</td><td>54.90 SEK</td><td>52-week low</td><td>Shelf only</td><td>Watching</td></tr><tr><td>Eggs 12-pack</td><td>35 SEK</td><td>34.90 SEK</td><td>Favorite stores only</td><td>Shelf, retailer page</td><td>Ready for email</td></tr><tr><td>Loose tomatoes</td><td>29 SEK/kg</td><td>Estimated</td><td>Confidence ≥ 80%</td><td>Estimated blocked</td><td>Held for review</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Notification guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied behavior</th></tr></thead><tbody><tr><td>Quiet hours</td><td>Push alerts pause from 21:00 to 07:00.</td></tr><tr><td>Confidence floor</td><td>Estimated prices cannot trigger household notifications.</td></tr><tr><td>Price-type filter</td><td>Alerts evaluate only the allowed shelf, member, promotion, or estimated price types stored on the watchlist rule.</td></tr><tr><td>Favorite-store scope</td><td>Scoped rules ignore stores outside the household basket set.</td></tr></tbody></table></section>${watchlistLivePanel}`
  },
  {
    path: 'watchlist/alerts/index.html',
    title: 'Watchlist alert rules — GroceryView',
    description: 'Audit GroceryView watchlist alert rules by target price, Deal Score trigger, source confidence, quiet hours, and delivery channel readiness.',
    body: `<section class="card"><div class="eyebrow">Watchlist alerts</div><h1>Watchlist alert rules</h1><p class="lede">Review target-price and Deal Score alert rules before notifications reach a household or update the alert inbox.</p><div class="grid"><div class="metric"><strong>5</strong><span>active rules</span></div><div class="metric"><strong>2</strong><span>ready to send</span></div><div class="metric"><strong>1</strong><span>quiet-hours hold</span></div></div></section><section class="card" style="margin-top:16px"><h2>Alert rule queue</h2><table class="table"><thead><tr><th>Rule</th><th>Trigger</th><th>Channel</th><th>Scope</th><th>Status</th></tr></thead><tbody><tr><td>Coffee target price</td><td>At or below 50 SEK</td><td>Push</td><td>Favorite stores</td><td>Ready to send</td></tr><tr><td>Eggs price drop</td><td>Retailer-page drop below 35 SEK</td><td>Email</td><td>Lidl Sveavägen</td><td>Ready to send</td></tr><tr><td>Butter 52-week low</td><td>Verified shelf low</td><td>Push</td><td>All Stockholm stores</td><td>Quiet-hours hold</td></tr><tr><td>Tomatoes confidence alert</td><td>Confidence reaches 80%</td><td>Digest</td><td>Produce category</td><td>Held for review</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Alert guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied rule</th></tr></thead><tbody><tr><td>Verified trigger source</td><td>Estimated or low-confidence prices cannot send target-price alerts.</td></tr><tr><td>Quiet-hours delivery</td><td>Non-critical push alerts wait for the morning digest between 21:00 and 07:00.</td></tr><tr><td>Channel readiness</td><td>Suppressed provider tokens stop future sends until the device refreshes.</td></tr></tbody></table></section>`
  },
  {
  ...
  {
    path: 'notifications/preferences/index.html',
    title: 'Notification preferences — GroceryView',
    description: 'Manage GroceryView notification channels, quiet hours, digest rules, suppression recovery, and alert preference guardrails.',
    body: `<section class="card"><div class="eyebrow">Notification preferences</div><h1>Notification preferences</h1><p class="lede">Review channel, digest, and quiet-hours settings before grocery alerts are delivered to a household.</p><div class="grid"><div class="metric"><strong>3</strong><span>active channels</span></div><div class="metric"><strong>21:00-07:00</strong><span>quiet hours</span></div><div class="metric"><strong>1</strong><span>suppressed device</span></div></div></section><section class="card" style="margin-top:16px"><h2>Preference rules</h2><table class="table"><thead><tr><th>Alert type</th><th>Channel</th><th>Quiet hours</th><th>Fallback</th></tr></thead><tbody><tr><td>Target-price alert</td><td>Push</td><td>Hold overnight</td><td>Morning digest</td></tr><tr><td>Receipt review reminder</td><td>Email</td><td>Allowed</td><td>Weekly summary</td></tr><tr><td>Meal-plan blocker</td><td>Push and email</td><td>Critical only</td><td>Household owner email</td></tr><tr><td>Provider suppression</td><td>Disabled push</td><td>n/a</td><td>Request device refresh</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Preference guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied rule</th></tr></thead><tbody><tr><td>Consent first</td><td>New channels remain off until the household explicitly enables them.</td></tr><tr><td>Quiet-hours respect</td><td>Non-critical grocery alerts wait for digest delivery during quiet hours.</td></tr><tr><td>Suppression recovery</td><td>Invalid push tokens stay disabled until a fresh device registration arrives.</td></tr></tbody></table></section>`
  },
  {
  ...
  {
    path: 'nutrition/labels/index.html',
    title: 'Nutrition label confidence — GroceryView',
    description: 'Review GroceryView nutrition label sources, macro completeness, salt and sugar warnings, and confidence rules before nutrition values affect swaps or meal plans.',
    body: `<section class="card"><div class="eyebrow">Nutrition labels</div><h1>Nutrition label confidence</h1><p class="lede">Confirm macro, allergen, salt, and sugar evidence before nutrition-per-krona rankings or meal-plan suggestions use label data.</p><div class="grid"><div class="metric"><strong>4</strong><span>labels reviewed</span></div><div class="metric"><strong>2</strong><span>warning flags</span></div><div class="metric"><strong>1</strong><span>manual source check</span></div></div></section><section class="card" style="margin-top:16px"><h2>Label review queue</h2><table class="table"><thead><tr><th>Product</th><th>Source</th><th>Signal</th><th>Decision</th></tr></thead><tbody><tr><td>Greek yoghurt 1kg</td><td>Retailer nutrition panel</td><td>High protein value</td><td>Allow ranking</td></tr><tr><td>Private-label cereal</td><td>OCR package photo</td><td>High sugar warning</td><td>Needs label check</td></tr><tr><td>Tomato soup</td><td>Manufacturer page</td><td>High salt warning</td><td>Show warning badge</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Label guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied rule</th></tr></thead><tbody><tr><td>Macro completeness</td><td>Calories, protein, sugar, salt, and package size must be present before value rankings update.</td></tr><tr><td>Warning preservation</td><td>Salt and sugar warnings stay visible even when a product has a strong Deal Score.</td></tr><tr><td>OCR review</td><td>OCR-only label data cannot approve meal-plan swaps until a reviewer confirms the panel.</td></tr></tbody></table></section>`
  },
  {
  ...
  {
    path: 'privacy/consent/index.html',
    title: 'Privacy consent center — GroceryView',
    description: 'Review GroceryView consent settings for ads, notifications, receipt retention, anonymous price contribution, and household privacy guardrails.',
    body: `<section class="card"><div class="eyebrow">Consent</div><h1>Privacy consent center</h1><p class="lede">Review opt-in states for ads, notifications, receipt retention, and anonymous price contribution before data powers personalized grocery decisions.</p><div class="grid"><div class="metric"><strong>4</strong><span>consent categories</span></div><div class="metric"><strong>2</strong><span>active opt-ins</span></div><div class="metric"><strong>0</strong><span>raw receipt ad shares</span></div></div></section><section class="card" style="margin-top:16px"><h2>Consent controls</h2><table class="table"><thead><tr><th>Control</th><th>State</th><th>Data scope</th><th>Action</th></tr></thead><tbody><tr><td>Personalized alerts</td><td>Enabled</td><td>Watchlist and budget signals</td><td>Manage notification preferences</td></tr><tr><td>Anonymous price contribution</td><td>Enabled</td><td>Store, product, price, no account id</td><td>Keep anonymous</td></tr><tr><td>Ad personalization</td><td>Disabled</td><td>Aggregated segments only</td><td>Keep opt-out</td></tr><tr><td>Receipt image retention</td><td>Limited</td><td>Raw images expire after review</td><td>Show retention clock</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Consent guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied rule</th></tr></thead><tbody><tr><td>Opt-in required</td><td>Personalized ad or notification uses remain disabled until the household enables them.</td></tr><tr><td>Receipt-safe ads</td><td>Raw receipt images and line-level household identity never enter advertiser payloads.</td></tr><tr><td>Anonymous contribution</td><td>Catalog price contributions strip account identifiers before backfill.</td></tr></tbody></table></section>`
  },
  {
  ...
  {
    path: 'stores/hours/index.html',
    title: 'Store hours and pickup windows — GroceryView',
    description: 'Review GroceryView store opening hours, pickup windows, holiday exceptions, and route-planning guardrails before checkout plans are suggested.',
    body: `<section class="card"><div class="eyebrow">Store hours</div><h1>Store hours and pickup windows</h1><p class="lede">Check opening hours and pickup windows before GroceryView suggests routes, split baskets, or time-sensitive coupon actions.</p><div class="grid"><div class="metric"><strong>5</strong><span>stores monitored</span></div><div class="metric"><strong>2</strong><span>pickup-ready windows</span></div><div class="metric"><strong>1</strong><span>holiday exception</span></div></div></section><section class="card" style="margin-top:16px"><h2>Today’s store windows</h2><table class="table"><thead><tr><th>Store</th><th>Open hours</th><th>Pickup window</th><th>Route note</th></tr></thead><tbody><tr><td>Willys Odenplan</td><td>07:00-22:00</td><td>18:00-20:00</td><td>Primary weekly basket</td></tr><tr><td>Lidl Sveavägen</td><td>08:00-21:00</td><td>No pickup</td><td>In-store split basket only</td></tr><tr><td>Coop Farsta</td><td>09:00-20:00</td><td>16:00-18:00</td><td>Member promo review first</td></tr><tr><td>Hemköp T-Centralen</td><td>Holiday hours 10:00-18:00</td><td>Closed</td><td>Top-up only</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Hours guardrails</h2><table class="table"><thead><tr><th>Guardrail</th><th>Applied rule</th></tr></thead><tbody><tr><td>No price ranking impact</td><td>Opening hours can change route timing but never Deal Score or shelf-price confidence.</td></tr><tr><td>Holiday exception label</td><td>Holiday hours must be shown before a store becomes the default checkout stop.</td></tr><tr><td>Pickup separation</td><td>Pickup availability is displayed beside route planning without overwriting verified prices.</td></tr></tbody></table></section>`
  },
  {
