...
const pages = [
  ...
  },
  {
    ...
    title: 'Retailer coverage — GroceryView',
    description: 'GroceryView retailer coverage dashboard for Stockholm chain freshness, product depth, and observation confidence.',
    body: `<section class="card"><div class="eyebrow">Coverage</div><h1>Retailer data coverage</h1><p class="lede">Track which chains have fresh observations, strong product depth, and enough confidence to power deals and alerts.</p><div class="grid"><div class="metric"><strong>5 chains</strong><span>active Stockholm coverage</span></div><div class="metric"><strong>92%</strong><span>fresh within 24 hours</span></div><div class="metric"><strong>1,240</strong><span>verified observations</span></div></div></section><section class="card" style="margin-top:16px"><h2>Chain readiness</h2><table class="table"><thead><tr><th>Chain</th><th>Store count</th><th>Freshness</th><th>Confidence</th><th>Product depth</th></tr></thead><tbody><tr><td>Willys</td><td>18 Stockholm stores</td><td>Updated 42 min ago</td><td>High confidence</td><td>Hero products plus pantry staples</td></tr><tr><td>ICA</td><td>24 Stockholm stores</td><td>Updated 2 h ago</td><td>Mixed confidence</td><td>Strong dairy and coffee depth</td></tr><tr><td>Coop</td><td>15 Stockholm stores</td><td>Updated 4 h ago</td><td>Needs receipt corroboration</td><td>Promotions and member prices</td></tr><tr><td>Lidl</td><td>9 Stockholm stores</td><td>Updated yesterday</td><td>Low confidence</td><td>Weekly specials only</td></tr></tbody></table></section>`
  },
  {
