...
const pages = [
  ...
  {
    path: 'heatmap/index.html',
    title: 'Category heatmap — GroceryView',
    description: 'Stockholm grocery category heatmap with chain-level movers, confidence labels, and deal signals.',
    body: `<section class="card"><div class="eyebrow">Heatmap</div><h1>Category heatmap</h1><p class="lede">Scan category and chain moves across Stockholm without letting low-confidence estimates look like verified shelf prices.</p><div class="grid"><div class="metric"><strong>Coffee</strong><span>best current sector</span></div><div class="metric"><strong>-8.4%</strong><span>largest 30D drop</span></div><div class="metric"><strong>91%</strong><span>average confidence</span></div></div></section><section class="card" style="margin-top:16px"><h2>Chain/category movers</h2><table class="table"><thead><tr><th>Category</th><th>Willys</th><th>ICA</th><th>Coop</th><th>Lidl</th><th>Confidence</th></tr></thead><tbody><tr><td>Coffee</td><td class="negative">-12.4%</td><td class="negative">-8.1%</td><td class="negative">-5.0%</td><td class="negative">-6.2%</td><td>Verified shelf + promo</td></tr><tr><td>Dairy</td><td class="positive">+1.6%</td><td class="positive">+2.4%</td><td class="negative">-1.2%</td><td class="negative">-3.1%</td><td>Mixed retailer page</td></tr><tr><td>Protein</td><td class="positive">+4.2%</td><td class="positive">+3.6%</td><td class="positive">+1.9%</td><td class="negative">-0.8%</td><td>Estimated receipt confidence</td></tr></tbody></table></section>`
  },
  {
