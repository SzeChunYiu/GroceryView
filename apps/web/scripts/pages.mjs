...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Market</div><h1>Stockholm Grocery Market</h1><p class="lede">Top movers, best true deals, and grocery indices for Stockholm.</p><div class="grid"><div class="metric"><strong>101.6</strong><span>Stockholm Grocery Index</span></div><div class="metric"><strong>91.6</strong><span>Coffee Index</span></div><div class="metric"><strong>108.4</strong><span>Dairy Index</span></div></div></section><section class="card" style="margin-top:16px"><h2>Basket-type indices</h2><table class="table"><thead><tr><th>Index</th><th>1W</th><th>1M</th><th>Cheapest chain</th><th>Cheapest area</th><th>Biggest driver</th></tr></thead><tbody><tr><td>Student Basket Index</td><td>-1.8%</td><td>+2.4%</td><td>Lidl</td><td>Kista</td><td>Coffee -7.2%</td></tr><tr><td>Family Basket Index</td><td>+0.6%</td><td>+3.1%</td><td>Willys</td><td>Solna</td><td>Dairy +6%</td></tr><tr><td>Budget Basket Index</td><td>-0.9%</td><td>+1.2%</td><td>Lidl</td><td>Södermalm</td><td>Pasta -4.8%</td></tr></tbody></table></section>`
  },
  {
