...
const pages = [
  ...
  },
  {
    ...
    path: 'dietary/index.html',
    title: 'Dietary preferences — GroceryView',
    description: 'GroceryView dietary preference page for allergens, excluded ingredients, and basket-safe substitutions.',
    body: `<section class="card"><div class="eyebrow">Preferences</div><h1>Dietary and allergen controls</h1><p class="lede">Keep basket recommendations and swaps aligned with household restrictions before a deal is shown as safe to buy.</p><div class="grid"><div class="metric"><strong>4</strong><span>active allergen flags</span></div><div class="metric"><strong>12</strong><span>blocked product matches</span></div><div class="metric"><strong>7</strong><span>safe substitutions</span></div></div></section><section class="card" style="margin-top:16px"><h2>Household rules</h2><table class="table"><thead><tr><th>Rule</th><th>Scope</th><th>Action</th><th>Evidence</th></tr></thead><tbody><tr><td>Nut allergy</td><td>All household baskets</td><td>Block unsafe swaps</td><td>Ingredient label required</td></tr><tr><td>Lactose-free dairy</td><td>Milk and yoghurt categories</td><td>Prefer lactose-free substitute</td><td>Catalog attribute verified</td></tr><tr><td>No pork</td><td>Prepared meals and deli</td><td>Hide from Deal Score recommendations</td><td>Manual review for ambiguous products</td></tr><tr><td>Vegetarian weekday basket</td><td>Monday to Friday</td><td>Suggest vegetarian alternatives</td><td>Household preference active</td></tr></tbody></table></section>`
  },
  {
