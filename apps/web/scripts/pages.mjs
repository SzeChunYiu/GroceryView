...
const pages = [
  ...
  {
    path: 'guides/coffee-price-index/index.html',
    title: 'Coffee price index guide — GroceryView',
    description: 'SEO-friendly GroceryView guide explaining coffee price indices, verified prices, Deal Score, and clearly labelled article display ads.',
    body: `<section class="card"><div class="eyebrow">Guide</div><h1>Coffee price index guide</h1><p class="lede">Learn how GroceryView reads verified prices, current Stockholm percentile, historical percentile, and Deal Score before deciding whether a coffee offer is a real deal.</p><div class="grid"><div class="metric"><strong>91.6</strong><span>Stockholm Coffee Index</span></div><div class="metric"><strong>12th</strong><span>historical percentile</span></div><div class="metric"><strong>Verified</strong><span>receipt and shelf-photo sources</span></div></div></section><section class="card" style="margin-top:16px"><h2>How to read the signal</h2><table class="table"><thead><tr><th>Signal</th><th>Meaning</th></tr></thead><tbody><tr><td>Current Stockholm percentile</td><td>Compares today's coffee prices across Stockholm stores.</td></tr><tr><td>Historical percentile</td><td>Compares today's price with the product's own history.</td></tr><tr><td>Deal Score</td><td>Ranks organic price evidence only; sponsored placements never improve the score.</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><div class="eyebrow">Sponsored</div><h2>Article display ad</h2><p class="lede">Clearly labelled sponsored placement. It is separated from organic rankings, Deal Score explanations, budget warnings, and scanner results.</p></section>`
  }
];
