...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Product ticker</div><h1>ZOEGAS-COFFEE-450G</h1><p class="lede">Current best price: 49.90 SEK at Willys Odenplan.</p><div class="grid"><div class="metric"><strong>82</strong><span>Deal Score</span></div><div class="metric"><strong>8th</strong><span>Stockholm percentile</span></div><div class="metric"><strong>6th</strong><span>Historical percentile</span></div></div></section><section class="card" style="margin-top:16px"><h2>Availability</h2><table class="table"><thead><tr><th>Store</th><th>Status</th><th>Source</th><th>Verified</th></tr></thead><tbody><tr><td>Willys Odenplan</td><td>In stock</td><td>Shelf photo</td><td>Verified 34 min ago</td></tr><tr><td>Lidl Sveavägen</td><td>Low stock</td><td>Retailer online</td><td>Verified</td></tr><tr><td>Coop Odenplan</td><td>Out of stock report</td><td>Community report</td><td>Needs confirmation</td></tr></tbody></table></section>`
  },
  {
