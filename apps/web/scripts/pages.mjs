...
const pages = [
  ...
  },
  {
    ...
    path: 'unit-prices/index.html',
    title: 'Unit price comparison — GroceryView',
    description: 'GroceryView unit-price comparison page for SEK per kg, liter, and piece across grocery package sizes.',
    body: `<section class="card"><div class="eyebrow">Unit prices</div><h1>Compare by unit price</h1><p class="lede">Normalize grocery offers across pack sizes so large packs, member prices, and promotions can be compared fairly.</p><div class="grid"><div class="metric"><strong>SEK/kg</strong><span>weight-based products</span></div><div class="metric"><strong>SEK/l</strong><span>milk, drinks, and cleaning</span></div><div class="metric"><strong>SEK/pc</strong><span>eggs and multipacks</span></div></div></section><section class="card" style="margin-top:16px"><h2>Normalized offers</h2><table class="table"><thead><tr><th>Product</th><th>Shelf price</th><th>Pack size</th><th>Unit price</th><th>Best comparison</th></tr></thead><tbody><tr><td>Zoégas Coffee 450g</td><td>49.90 SEK</td><td>450 g</td><td>110.89 SEK/kg</td><td>Cheaper than 500g premium coffee</td></tr><tr><td>Garant Bryggkaffe 450g</td><td>37.90 SEK</td><td>450 g</td><td>84.22 SEK/kg</td><td>Best private-label coffee</td></tr><tr><td>Arla Milk 1L</td><td>12.90 SEK</td><td>1 l</td><td>12.90 SEK/l</td><td>Verified member price</td></tr><tr><td>Eggs 12-pack</td><td>34.90 SEK</td><td>12 pcs</td><td>2.91 SEK/pc</td><td>Cheapest multipack today</td></tr></tbody></table></section>`
  },
  {
