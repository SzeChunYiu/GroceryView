...
const pages = [
  ...
  },
  {
    ...
    path: 'seasonal/index.html',
    title: 'Seasonal grocery calendar — GroceryView',
    description: 'GroceryView seasonal calendar for produce windows, expected price drops, and confidence-backed basket planning.',
    body: `<section class="card"><div class="eyebrow">Seasonal</div><h1>Seasonal grocery calendar</h1><p class="lede">Plan baskets around produce windows, expected price drops, and confidence-backed signals from current Stockholm observations.</p><div class="grid"><div class="metric"><strong>6</strong><span>in-season categories</span></div><div class="metric"><strong>-18%</strong><span>expected berry move</span></div><div class="metric"><strong>High</strong><span>produce confidence</span></div></div></section><section class="card" style="margin-top:16px"><h2>Seasonal signals</h2><table class="table"><thead><tr><th>Category</th><th>Season window</th><th>Price signal</th><th>Basket action</th><th>Evidence</th></tr></thead><tbody><tr><td>Strawberries</td><td>June to July</td><td>Expected drop next week</td><td>Wait for weekend promo</td><td>Retailer flyers plus shelf photos</td></tr><tr><td>New potatoes</td><td>May to August</td><td>Already below median</td><td>Buy for weekly basket</td><td>Verified market observations</td></tr><tr><td>Asparagus</td><td>April to June</td><td>Peak price ending</td><td>Swap to broccoli soon</td><td>Mixed confidence</td></tr><tr><td>Citrus</td><td>December to March</td><td>Off-season premium</td><td>Hide from true deals</td><td>Historical percentile high</td></tr></tbody></table></section>`
  },
  {
