...
const pages = [
  ...
  {
    path: 'meals/index.html',
    title: 'Deal-based meal planner — GroceryView',
    description: 'GroceryView meal planner page for budget meals generated from current high-scoring grocery deals.',
    body: `<section class="card"><div class="eyebrow">Meal planner</div><h1>Deal-based meal planner</h1><p class="lede">Turn current high-scoring grocery deals into weekly meals under budget.</p><div class="grid"><div class="metric"><strong>104.70 SEK</strong><span>estimated meal total</span></div><div class="metric"><strong>34.90 SEK</strong><span>cost per serving</span></div><div class="metric"><strong>3</strong><span>deal-backed ingredients</span></div></div></section><section class="card" style="margin-top:16px"><h2>Suggested meals</h2><table class="table"><thead><tr><th>Meal</th><th>Ingredients</th><th>Reason</th></tr></thead><tbody><tr><td>Chicken thighs pasta bowl</td><td>chicken, pasta, tomatoes</td><td>Uses high-scoring current deals across protein, pantry, and vegetables.</td></tr></tbody></table></section><section class="card" style="margin-top:16px"><h2>Budget guardrail</h2><p class="lede">The plan stays under the 110 SEK meal cap and keeps per-serving cost visible before adding ingredients to the weekly basket.</p></section>`
  },
  {
