...
const pages = [
  ...
  },
  {
    ...
    title: 'Community verification — GroceryView',
    description: 'Community verification queue for grocery price observations, disputed receipts, and low-confidence estimates.',
    body: `<section class="card"><div class="eyebrow">Community verification</div><h1>Price verification queue</h1><p class="lede">Separate verified shelf observations from disputed receipts and low-confidence estimates before they affect product pages, alerts, or Deal Score.</p><div class="grid"><div class="metric"><strong>18</strong><span>verified today</span></div><div class="metric"><strong>5</strong><span>needs reviewer</span></div><div class="metric"><strong>2</strong><span>disputed observations</span></div></div></section><section class="card" style="margin-top:16px"><h2>Observation review</h2><table class="table"><thead><tr><th>Observation</th><th>Source type</th><th>Confidence</th><th>Status</th><th>Action</th></tr></thead><tbody><tr><td>ZOEGAS-COFFEE-450G at Willys Odenplan</td><td>Verified shelf photo</td><td>94%</td><td>Verified</td><td>Publish to product page</td></tr><tr><td>ARLA-MILK-1L at Coop Farsta</td><td>Receipt OCR</td><td>68%</td><td>Needs human review</td><td>Confirm loyalty discount</td></tr><tr><td>BUTTER-600G at ICA Liljeholmen</td><td>Retailer page</td><td>72%</td><td>Disputed</td><td>Request second source</td></tr><tr><td>EGGS-12P at Lidl Sveavägen</td><td>Community report</td><td>55%</td><td>Low confidence</td><td>Hold out of Deal Score</td></tr></tbody></table></section>`
  },
  {
