...
const pages = [
  ...
  },
  {
    ...
    path: 'loyalty/index.html',
    title: 'Member prices — GroceryView',
    description: 'GroceryView member-price tracker for loyalty requirements, non-member fallbacks, and verified savings.',
    body: `<section class="card"><div class="eyebrow">Loyalty</div><h1>Member price tracker</h1><p class="lede">See which grocery deals require a store membership, what the non-member fallback costs, and whether the savings are verified.</p><div class="grid"><div class="metric"><strong>14</strong><span>active member deals</span></div><div class="metric"><strong>86 SEK</strong><span>verified weekly savings</span></div><div class="metric"><strong>3 chains</strong><span>loyalty programs matched</span></div></div></section><section class="card" style="margin-top:16px"><h2>Member requirements</h2><table class="table"><thead><tr><th>Offer</th><th>Member price</th><th>Fallback price</th><th>Requirement</th><th>Evidence</th></tr></thead><tbody><tr><td>Zoégas Coffee 450g at Willys</td><td>49.90 SEK</td><td>64.90 SEK</td><td>Willys Plus card</td><td>Verified shelf sign</td></tr><tr><td>Arla Milk 1L at Coop</td><td>12.90 SEK</td><td>15.90 SEK</td><td>Coop membership</td><td>Receipt OCR confirmed</td></tr><tr><td>ICA Butter 600g</td><td>39.90 SEK</td><td>52.90 SEK</td><td>ICA Stammis login</td><td>Retailer page pending shelf check</td></tr></tbody></table></section>`
  },
  {
