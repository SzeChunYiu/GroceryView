...
const pages = [
  ...
  },
  {
    ...
    body: `<section class="card"><div class="eyebrow">Store</div><h1>Willys Odenplan</h1><p class="lede">Favorite-store profile for Odenplan grocery deals.</p><div class="grid"><div class="metric"><strong>82</strong><span>Deal Score Today</span></div><div class="metric"><strong>-12%</strong><span>vs Stockholm average</span></div><div class="metric"><strong>Coffee</strong><span>Best category</span></div></div></section><section class="card" style="margin-top:16px"><h2>Store deal feed</h2><table class="table"><thead><tr><th>Product</th><th>Price</th><th>Deal Score</th><th>Signal</th></tr></thead><tbody><tr><td>ZOEGAS-COFFEE-450G<br><span class="footer-note">public shelf · observed 2026-05-19 09:00</span></td><td>49.90 SEK<br><span class="footer-note">110.89 SEK/kg</span></td><td>82</td><td>High confidence 52-week-low candidate</td></tr><tr><td>ARLA-MILK-1L<br><span class="footer-note">member promo · observed 2026-05-19 08:30</span></td><td>14.90 SEK<br><span class="footer-note">14.90 SEK/l</span></td><td>77</td><td>Member price, not universal shelf price</td></tr><tr><td>EGGS-12P<br><span class="footer-note">promo estimate · observed 2026-05-18 18:20</span></td><td>34.90 SEK<br><span class="footer-note">2.91 SEK/egg</span></td><td>68</td><td>Unverified estimate, compare before buying</td></tr></tbody></table></section>`
  },
  {
