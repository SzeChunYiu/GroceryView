...
describe('buildStaticPages', () => {
  it('generates proposal-required SEO and user-flow pages', async () => {
    ...
    try {
      ...
      assert.match(market, /Selected district indices/);
      assert.match(market, /Odenplan Grocery Index/);
      assert.match(market, /Kista Student Basket Index/);
      assert.match(market, /cheapest selected district/);
