...
describe('verified-data UI', () => {
  ...
  it('wires the latest ICA store-scoped promotion import to visible source surfaces', async () => {
    ...
    assert.match(generated, /retrieved 2026-05-25T10:01:04\.223Z/);
    ...
    assert.match(summary, /"totalRowCount": 88290/);
    assert.match(summary, /"storeEndpointCount": 327/);
    ...
    assert.match(summary, /"retrievedAt": "2026-05-25T10:01:04\.223Z"/);
