...
describe('verified-data UI', () => {
  ...
  it('wires the latest ICA store-scoped promotion import to visible source surfaces', async () => {
    ...
    assert.match(generated, /ICA Supermarket Vännäs/);
    assert.match(generated, /"storeAccountId":"1003566"/);
    assert.match(generated, /ICA Supermarket Tierp/);
    assert.match(generated, /"storeAccountId":"1003693"/);
    assert.match(generated, /retrieved 2026-05-23T19:35:14\.000Z/);
    ...
    assert.match(summary, /totalRowCount: 93085/);
    ...
    assert.match(summary, /ICA Supermarket Vännäs/);
    assert.match(summary, /storeAccountId: '1003566'/);
    assert.match(summary, /ICA Supermarket Tierp/);
    assert.match(summary, /storeAccountId: '1003693'/);
    assert.match(summary, /retrievedAt: '2026-05-23T19:35:14\.000Z'/);
