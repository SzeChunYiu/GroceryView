...
${seo}`;
  ...
  it('surfaces query-driven chain comparison table on the compare route', async () => {
    ...
    assert.match(route, /noChainCapabilityLinks\.map/);
    assert.match(route, /No-chain capabilities/);
    assert.match(route, /\/data-sources#chain-capability-\$\{chain\.id\}/);
  ...
  it('surfaces verified source coverage on the data sources route', async () => {
    ...
    assert.match(route, /chainCapabilityAudit\.map/);
    assert.match(route, /Chain capability audit/);
    assert.match(route, /chain-capability-\$\{chain\.id\}/);
