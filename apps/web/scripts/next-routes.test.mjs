...
${seo}`;
  ...
  it('surfaces query-driven chain comparison table on the compare route', async () => {
    ...
    assert.match(route, /No-chain capability list/);
    assert.match(route, /comparison\.noChainState\.capabilities\.map/);
    assert.match(route, /\/data-sources#\$\{compareChainCapabilityAnchor\(capability\.chainId\)\}/);
  ...
  it('surfaces verified source coverage on the data sources route', async () => {
    ...
    assert.match(route, /dbSiteCompareStoreCapabilities\.map/);
    ...
    assert.match(route, /Compare capability audit/);
    assert.match(route, /compare-chain-capability-\$\{chainId\}/);
    assert.match(route, /Per-chain compare filter evidence/);
