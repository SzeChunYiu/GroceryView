...
${seo}`;
  ...
  it('ships connected UX helpers, breadcrumbs, and product entity routes', async () => {
    ...
    const dealPreviewCard = await read('src/components/preview/deal-preview-card.tsx');
    assert.match(dealPreviewCard, /RelatedLinksPanel/);
    assert.match(deals, /DealFeedWithPreviews/);
