...
describe('verified-data UI', () => {
  ...
  it('wires the latest ICA store-scoped promotion import to visible source surfaces', async () => {
    ...
    assert.match(generated, /retrieved 2026-05-23T13:59:01\.000Z/);
    ...
    assert.match(summary, /retrievedAt: '2026-05-23T13:59:01\.000Z'/);
...
${seo}`;
  ...
  it('ships JSON-LD organization, site search, product offer, and breadcrumb metadata', async () => {
    ...
    assert.match(productRoute, /price: row\.price/);
    assert.match(productRoute, /availability: 'https:\/\/schema\.org\/InStock'/);
    assert.match(productRoute, /availableAtOrFrom: \{ '@type': 'Store'/);
    assert.match(productRoute, /seller: \{ '@type': 'Organization'/);
